package com.bdsoft.y2011.m12.zch.filter;
...
public class WordFilterUtil {
	...
	static {
		InputStream is = WordFilterUtil.class
				.getResourceAsStream("/words.dict");
		try {
	...
	private static PunctuationOrHtmlFilteredResult filterPunctation(
	...
	private static PunctuationOrHtmlFilteredResult filterPunctationAndHtml(
			String originalString) {
		StringBuffer filteredString = new StringBuffer();
		ArrayList charOffsets = new ArrayList();
		int i = 0;
	...
	private static FilteredResult filter(
			PunctuationOrHtmlFilteredResult pohResult, char replacement) {
	...
	public static FilteredResult filterHtml(String originalString,
			char replacement) {
