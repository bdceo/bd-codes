...
enum Unit {
    ...
    GE("个(元)", 1, 10), SHI("十", 10, 100), BAI("百", 100, 1000), QIAN("千", 1000, 1_0000),
    WAN("万", 1_0000, 10_0000), SHIWAN("十", 10_0000, 100_0000), BAIWAN("百", 100_0000, 1000_0000),
    QIANWAN("千", 1000_0000, 1_0000_0000), YI("亿", 1_0000_0000, 10_0000_0000);

    private String name;
    private int sub;
    private int mod;

    Unit(String name, int sub, int mod) {
        this.name = name;
        this.sub = sub;
        this.mod = mod;
    }
